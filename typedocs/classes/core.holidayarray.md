[Moment Holiday (by Nesto)](../README.md) > [core](../modules/core.md) > [HolidayArray](../classes/core.holidayarray.md)

# Class: HolidayArray

This is an array implementation which ships special sort functions for holiday containments.

## Type parameters
#### T :  [Holiday](core.holiday.md)
## Hierarchy
...
* [length](core.holidayarray.md#length)
* [Array](core.holidayarray.md#array)

### Methods

* [__@iterator](core.holidayarray.md#___iterator)
* [__@unscopables](core.holidayarray.md#___unscopables)
* [concat](core.holidayarray.md#concat)
* [copyWithin](core.holidayarray.md#copywithin)
* [entries](core.holidayarray.md#entries)
* [every](core.holidayarray.md#every)
* [fill](core.holidayarray.md#fill)
* [filter](core.holidayarray.md#filter)
* [filterHolidays](core.holidayarray.md#filterholidays)
* [find](core.holidayarray.md#find)
* [findIndex](core.holidayarray.md#findindex)
* [flat](core.holidayarray.md#flat)
* [flatMap](core.holidayarray.md#flatmap)
* [forEach](core.holidayarray.md#foreach)
* [includes](core.holidayarray.md#includes)
* [indexOf](core.holidayarray.md#indexof)
* [join](core.holidayarray.md#join)
* [keys](core.holidayarray.md#keys)
* [lastIndexOf](core.holidayarray.md#lastindexof)
* [map](core.holidayarray.md#map)
* [pop](core.holidayarray.md#pop)
* [push](core.holidayarray.md#push)
* [reduce](core.holidayarray.md#reduce)
* [reduceRight](core.holidayarray.md#reduceright)
* [reverse](core.holidayarray.md#reverse)
* [shift](core.holidayarray.md#shift)
* [slice](core.holidayarray.md#slice)
* [some](core.holidayarray.md#some)
* [sort](core.holidayarray.md#sort)
* [sortHolidaysAscending](core.holidayarray.md#sortholidaysascending)
* [sortHolidaysDescending](core.holidayarray.md#sortholidaysdescending)
* [splice](core.holidayarray.md#splice)
* [toLocaleString](core.holidayarray.md#tolocalestring)
* [toString](core.holidayarray.md#tostring)
* [unshift](core.holidayarray.md#unshift)
* [values](core.holidayarray.md#values)
* [withoutCountryHolidays](core.holidayarray.md#withoutcountryholidays)
...
*Overrides Array.[Symbol.iterator]*
...
*Overrides Array.[Symbol.unscopables]*
...
*Defined in node_modules/typedoc/node_modules/typescript/lib/lib.es5.d.ts:1166*
...
___
<a id="filterholidays"></a>

###  filterHolidays

▸ **filterHolidays**(predicate: *`function`*): [HolidayArray](core.holidayarray.md)<`T`>

*Defined in [packages/core/src/holiday-array.ts:45](https://github.com/nesto-software/moment-holiday/blob/72ce1a6/packages/core/src/holiday-array.ts#L45)*
...
| Param | Type | Description |
| ------ | ------ | ------ |
| predicate | `function` |  the predicate to test against |

**Returns:** [HolidayArray](core.holidayarray.md)<`T`>
...
*Defined in node_modules/typedoc/node_modules/typescript/lib/lib.es5.d.ts:1171*
...
*Defined in node_modules/typedoc/node_modules/typescript/lib/lib.es5.d.ts:1151*
...
*Defined in node_modules/typedoc/node_modules/typescript/lib/lib.es5.d.ts:1156*
...
*Defined in node_modules/typedoc/node_modules/typescript/lib/lib.es5.d.ts:1262*
...
*Defined in node_modules/typedoc/node_modules/typescript/lib/lib.es5.d.ts:1269*
...
*Defined in node_modules/typedoc/node_modules/typescript/lib/lib.es5.d.ts:1275*
...
*Defined in node_modules/typedoc/node_modules/typescript/lib/lib.es5.d.ts:1276*
...
*Defined in node_modules/typedoc/node_modules/typescript/lib/lib.es5.d.ts:1282*
...
*Defined in node_modules/typedoc/node_modules/typescript/lib/lib.es5.d.ts:1175*
...
___
<a id="sortholidaysascending"></a>

###  sortHolidaysAscending

▸ **sortHolidaysAscending**(): [HolidayArray](core.holidayarray.md)<[Holiday](core.holiday.md)>

*Defined in [packages/core/src/holiday-array.ts:13](https://github.com/nesto-software/moment-holiday/blob/72ce1a6/packages/core/src/holiday-array.ts#L13)*

Returns an array which is sorted so that the earliest dates come first.

**Returns:** [HolidayArray](core.holidayarray.md)<[Holiday](core.holiday.md)>

___
<a id="sortholidaysdescending"></a>

###  sortHolidaysDescending

▸ **sortHolidaysDescending**(): [HolidayArray](core.holidayarray.md)<[Holiday](core.holiday.md)>

*Defined in [packages/core/src/holiday-array.ts:29](https://github.com/nesto-software/moment-holiday/blob/72ce1a6/packages/core/src/holiday-array.ts#L29)*

Returns an array which is sorted so that the latest dates come first.
...
*Defined in node_modules/typedoc/node_modules/typescript/lib/lib.es5.d.ts:1147*
...
___
<a id="withoutcountryholidays"></a>

###  withoutCountryHolidays

▸ **withoutCountryHolidays**(): [HolidayArray](core.holidayarray.md)<`T`>

*Defined in [packages/core/src/holiday-array.ts:60](https://github.com/nesto-software/moment-holiday/blob/72ce1a6/packages/core/src/holiday-array.ts#L60)*
